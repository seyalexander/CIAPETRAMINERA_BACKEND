package com.SEYACLOUD.GestionDocumentosApi.feactures.empleados.infraestructure.controller;
...
import com.SEYACLOUD.GestionDocumentosApi.feactures.empleados.application.useCase.*;
...
import com.SEYACLOUD.GestionDocumentosApi.websockets.domain.services.NotificacionEmpleadoService;
...
public class EmpleadoController {
    ...
    public ResponseEntity<ResponseListaEmpleados> listaEmplados(@Validated @ModelAttribute RequestListaEmpleados request) {

        ResponseListaEmpleados response = listaEmpleadoUseCase.ListarEmpleado(request);
    ...
    public ResponseEntity<ResponseRegistroEmpleados> registroEmpleado(
            @Validated @RequestBody RequestRegistroEmpleados request) {

        ResponseRegistroEmpleados response = registroEmpleadoUseCase.RegistrorEmpleado(request);
    ...
    public ResponseEntity<ResponseEdicionAllEmpleados> edicionAllEmpleado(
            @Validated @RequestBody RequestEdicionAllEmpleados request) {

        ResponseEdicionAllEmpleados response = edicionEmpleadoUseCase.EditarEmpleado(request);
    ...
    public ResponseEntity<ResponseEdicionEstadoEmpleados> anularEmpleado(@PathVariable long idEmpleado) {

        ResponseEdicionEstadoEmpleados response = edicionEmpleadoEstadoUseCase.AnularEmpleado(idEmpleado);
    ...
    public ResponseEntity<ResponseEdicionEstadoEmpleados> activarEmpleado(@PathVariable long idEmpleado) {

        ResponseEdicionEstadoEmpleados response = edicionEmpleadoEstadoUseCase.ActivarEmpleado(idEmpleado);
    ...
    public ResponseEntity<ResponseDetalleEmpleados> detalleEmpleado(@PathVariable long idEmpleado) {

        ResponseDetalleEmpleados response = detalleEmpleadoUseCase.DetalleEmpleado(idEmpleado);
