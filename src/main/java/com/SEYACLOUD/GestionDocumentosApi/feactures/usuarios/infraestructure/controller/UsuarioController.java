package com.SEYACLOUD.GestionDocumentosApi.feactures.usuarios.infraestructure.controller;
...
import com.SEYACLOUD.GestionDocumentosApi.feactures.usuarios.application.useCase.*;
...
public class UsuarioController {
    ...
    public ResponseEntity<ResponseListaUsuario> listaUsuarios(@Validated @ModelAttribute RequestListaUsuario request) {
